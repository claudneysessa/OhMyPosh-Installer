...
```powershell
powershell.exe -ExecutionPolicy Bypass -File "C:/tools/OhMyPosh-Installer/Set-Theme.ps1" -Name "$ARGUMENTS"
```
...
```powershell
powershell.exe -ExecutionPolicy Bypass -File "C:/tools/OhMyPosh-Installer/Set-Theme.ps1" -Preview "nome-do-tema"
```
